  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full items-start">
        <div className="flex max-w-[42rem] flex-col items-start  ">
          ...
          <h2 className="font-accent text-[clamp(1rem,2vw+1rem,4rem)] font-bold uppercase leading-14 tracking-normal text-black">
            A welcoming start
            <br />
            to every school day
          </h2>

          <div className="my-6 h-1 w-18 rounded-full bg-[#8bbaf7]" />


          <p className="max-w-[20rem] mb-4 text-md leading-[1.35] text-[#3c4b66] ">
            Bright, calm spaces help children feel comfortable, confident, and ready to learn.
          </p>

          <a
            href="/demo1/contact"
            className="inline-flex items-center gap-3 rounded-2xl border border-white/70 bg-[#f8b92b] px-5 py-3 text-sm font-semibold text-black shadow-[0_18px_44px_rgba(248,185,43,0.28)] transition-transform duration-300 hover:-translate-y-0.5 cursor-pointer"
          >
      ...
      <div className="pointer-events-none absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 items-center gap-4 bg-white/80 px-4 py-2 rounded-full backdrop-blur-sm">
