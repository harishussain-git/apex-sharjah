  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-[900] flex -translate-x-1/2 items-center gap-3 rounded-full bg-white/50 p-2 backdrop-blur-lg">
      <button
        ...
        className="grid size-12 place-items-center rounded-full border border-slate-200 bg-white/80 text-[#081947] shadow-[0_14px_35px_rgba(8,25,71,0.12)] transition hover:bg-white disabled:pointer-events-none disabled:opacity-40"
      >
